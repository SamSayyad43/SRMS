...
class reportClass:
    def __init__(self,root):
        ...
        #title
        title=Label(self.root,text="View Student Result",font=("goudy old style",20,"bold"),bg="orange").place(x=0,y=15,width=1200,height=60)
       # search
        ...
        btn_search=Button(self.root,text='Search',font=("goudy old style",15,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=680,y=100,width=120,height=35) 
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,'bold'),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=820,y=100,width=120,height=35) 
     # labels
        ...
        lbl_FullMarks=Label(self.root,text="Total Marks",font=("goudy old style",15,'bold'),bg="white",bd=2,relief=GROOVE).place(x=750,y=230,width=150,height=50)
